d3.custom.horizontalBar = function () {
	...
	function chart(selection) {
		selection.each(function(data) {
			...
			// Debugging messages
			//console.log("Left Bar field names:");
			//console.log(leftFields);
			//console.log("Left Bar color domain:");
			//console.log(lcolorScale.domain());
			//console.log("Right Bar field names:");
			//console.log(rightFields);
			//console.log("Right Bar color domain:");
			//console.log(rcolorScale.domain());
			//
